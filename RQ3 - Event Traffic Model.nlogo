...
;;turnleft2 (used after drop-off, taxi make random turns to try and search for new customers, until they arrive at the edge of map and leave the system)
;;turnright2 (used after drop-off, taxi make random turns to try and search for new customers, until they arrive at the edge of map and leave the system)
...
;;codes in this section are written by me
@#$#@#$#@
GRAPHICS-WINDOW
219
10
...
Press the event-taxi-arrivals button to start an event, and event taxis will be arriving in the following hour.
